...
const METHODS = [
  { icon: <FaMoneyBillWave />, label: 'Efectivo', delay: 0 },
  { icon: <FaCreditCard />, label: 'Débito / Crédito', delay: 100 },
  { icon: <FaMobileScreen />, label: 'Transferencia', delay: 200 },
]

export default function PaymentMethods() {
  return (
    <section className="payment-methods">
      <div className="payment-bg-pattern" />
